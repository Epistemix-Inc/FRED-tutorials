...
- Used a custom bash script to perform a [parameter sweep](https://epistemix-fred-guide.readthedocs-hosted.com/en/dev/user_guide/chapter17/chapter17.html#chapter-17-running-parameter-sweeps)
